...
val troubleshootQuestions = listOf(
    ...
    TroubleshootItem("From where do the widget pull quotes from?", "The widget pulls quotes from three sources: online, your favorites, or your own custom entries. You can easily choose your preferred source in the settings."),
